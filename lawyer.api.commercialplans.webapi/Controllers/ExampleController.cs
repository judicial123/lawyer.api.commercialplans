...
using lawyer.api.commercialplans.application.UseCases.Example.Delete;
using lawyer.api.commercialplans.application.UseCases.Example.GetAll;
using lawyer.api.commercialplans.application.UseCases.Example.GetById;
