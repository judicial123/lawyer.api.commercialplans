...
using lawyer.api.commercialplans.application.UseCases.City.Delete;
using lawyer.api.commercialplans.application.UseCases.City.GetAll;
using lawyer.api.commercialplans.application.UseCases.City.GetById;
